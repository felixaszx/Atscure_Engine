...
VkPhysicalDevice as::Handle::physical_device_{};
VkDevice as::Handle::device_{};
VmaAllocator as::Handle::allocator_{};
VkQueue as::Handle::graphics_queue_{};
...
as::Result as::Device::create(VkInstance instance, const std::vector<const char*>& enabled_layers)
{
...
void as::Device::destroy()
{
    while (!handles_.empty())
    {
        delete handles_.front();
        handles_.pop_front();
    }
